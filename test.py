...
def main():
    ...
    .stSuccess { background-color: rgba(74, 134, 232, 0.15); border-color: rgba(74, 134, 232, 0.3); }
    .stWarning { background-color: rgba(255, 159, 10, 0.15); border-color: rgba(255, 159, 10, 0.3); }
    .stError { background-color: rgba(255, 59, 48, 0.15); border-color: rgba(255, 59, 48, 0.3); }
    .stInfo { background-color: rgba(94, 92, 230, 0.15); border-color: rgba(94, 92, 230, 0.3); }
    </style>
